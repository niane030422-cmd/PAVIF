...
Update the paths in the training scripts as needed:
...
Set `MODEL_PATH` in `examples/qwen3_4b_stage2.sh` to the checkpoint exported from Stage 1:

```bash
MODEL_PATH="./outputs/checkpoints/instruct_stage1/qwen3_4b_stage1/global_step_50/actor/huggingface"
```
